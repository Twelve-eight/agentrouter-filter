// GENERATED by tools/gen-filter-core.mjs from
// G:/omp works/.omp/hooks/pre/strip-illegal.ts (lines 19-196).
...
export const CORE_SOURCE = { file: "G:/omp works/.omp/hooks/pre/strip-illegal.ts", from: 19, to: 196 };
